...
'TGFB1' :	{'description':'TGFB1 ( transforming growth factor beta 1) attenuates tumour response to PD-L1 blockade by contributing to exclusion of T cells. Combination TGF-beta inhibition and immunotherapy induces complete responses in mouse models.', 'pmid':'29443960'},
}
